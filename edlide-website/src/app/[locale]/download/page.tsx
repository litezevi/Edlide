        ...
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              Windows x64 <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.8</span> <span className="text-xs text-green-400 ml-2">{t('stable')}</span>
            </CardTitle>
        ...
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              macOS ARM <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.8</span> <span className="text-xs text-green-400 ml-2">{t('stable')}</span>
            </CardTitle>
            <CardDescription className="flex items-center gap-2">
              <span className="text-xs">February 20, 2026</span>
            </CardDescription>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              <img src={windowsLogo} alt="Windows" className="w-[26px] h-[26px] object-contain" />
              Windows ARM <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.8</span> <span className="text-xs text-green-400 ml-2">{t('stable')}</span>
            </CardTitle>
            <CardDescription className="flex items-center gap-2">
              <span className="text-xs">February 20, 2026</span>
            </CardDescription>
        ...
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              macOS Intel <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.8</span> <span className="text-xs text-green-400 ml-2">{t('stable')}</span>
            </CardTitle>
            <CardDescription className="flex items-center gap-2">
              <span className="text-xs">February 20, 2026</span>
            </CardDescription>
