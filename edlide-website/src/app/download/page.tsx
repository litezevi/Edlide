        ...
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              macOS ARM <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.4</span> <span className="text-xs bg-green-900/50 text-green-400 px-1.5 py-0.5 rounded ml-2">stable</span>
            </CardTitle>
            <CardDescription className="flex items-center gap-2">
              <span className="text-xs">January 29, 2026</span>
            </CardDescription>
        ...
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              macOS Intel <span className="text-sm font-normal text-muted-foreground ml-2">v1.0.4</span> <span className="text-xs bg-green-900/50 text-green-400 px-1.5 py-0.5 rounded ml-2">stable</span>
            </CardTitle>
            <CardDescription className="flex items-center gap-2">
              <span className="text-xs">January 29, 2026</span>
            </CardDescription>
