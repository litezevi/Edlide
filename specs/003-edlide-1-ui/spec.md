...
- **FR-003**: System MUST предоставлять 4 предустановленные модели Edlide: `zai-org/GLM-4.6:THINKING-turbo`, `deepseek-ai/DeepSeek-V3.1-Terminus`, `deepseek-ai/DeepSeek-V3.1-Terminus`, `moonshotai/Kimi-K2-Instruct-0905`
