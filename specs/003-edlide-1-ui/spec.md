...
- **FR-002**: System MUST размещать Edlide выше Anthropic в списке провайдеров
...
- **FR-004**: System MUST включать все модели Edlide по умолчанию без дополнительной настройки
...
- **FR-007**: System MUST скрывать возможность редактирования API ключа и base URL для провайдера Edlide
...
- **FR-010**: System MUST обрабатывать ошибки подключения к API Edlide [NEEDS CLARIFICATION: конкретное поведение при ошибках]
