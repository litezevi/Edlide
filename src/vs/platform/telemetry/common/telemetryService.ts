...
Edlide separately records basic usage like the number of messages people are sending. If you'd like to disable Edlide metrics, you may do so in Edlide's Settings.
`;
